...
//        public virtual async Task<OASISResult<T1>> CreateAsync(Guid avatarId, string name, string description, object holonSubType, string fullPathToSourceFolder, Dictionary<string, object> metaData = null, T1 newHolon = default, T4 STARNETDNA = null, bool checkIfSourcePathExists = true, ProviderType providerType = ProviderType.Default)
//        {
...
//        public virtual OASISResult<T1> Create(Guid avatarId, string name, string description, object holonSubType, string fullPathToSourceFolder, Dictionary<string, object> metaData = null, T1 newHolon = default, T4 STARNETDNA = null, bool checkIfSourcePathExists = true, ProviderType providerType = ProviderType.Default)
//        {
//            OASISResult<T1> result = new OASISResult<T1>();
...
//                                    //TODO: Maybe add check to make sure the DNA has not been tampered with?
//                                    loadOAPPResult.Result.STARNETDNA.Version = readSTARNETDNAResult.Result.Version; //Set the new version set in the DNA (JSON file).
//                                    T4 STARNETDNA = loadOAPPResult.Result.STARNETDNA; //Make sure it has not been tampered with by using the stored version.
