...
namespace NextGenSoftware.OASIS.API.ONODE.Core.Managers
{
    public abstract class OAPPSystemManagerBase<T1, T2, T3> : PublishManagerBase where T1 : IOAPPSystemHolon, new() where T2 : IDownloadedOAPPSystemHolon, new() where T3 : IInstalledOAPPSystemHolon, new()
    {
        ...
        public delegate void PublishStatusChanged(object sender, OAPPSystemHolonPublishStatusEventArgs e);
        public delegate void InstallStatusChanged(object sender, OAPPSystemHolonInstallStatusEventArgs e);
        public delegate void UploadStatusChanged(object sender, OAPPSystemHolonUploadProgressEventArgs e);
        public delegate void DownloadStatusChanged(object sender, OAPPSystemHolonDownloadProgressEventArgs e);
        ...
        protected HolonType OAPPSystemHolonType { get; set; } = HolonType.OAPPSystemHolon;
        protected HolonType OAPPSystemInstalledHolonType { get; set; } = HolonType.InstalledOAPPSystemHolon;
        protected string OAPPSystemHolonUIName { get; set; } = "OAPP System Holon";
        protected string OAPPSystemHolonIdName { get; set; } = "OAPPSystemHolonId";
        protected string OAPPSystemHolonNameName { get; set; } = "OAPPSystemHolonName";
        protected string OAPPSystemHolonTypeName { get; set; } = "OAPPSystemHolonType";
        protected string OAPPSystemHolonFileExtention { get; set; } = "oappsystemholon";
        protected string OAPPSystemHolonGoogleBucket { get; set; } = "oasis_oappsystemholons";
        ...
        protected virtual async Task<OASISResult<T1>> CreateAsync(Guid avatarId, string name, string description, object holonSubType, string fullPathToT, Dictionary<string, object> metaData = null, ProviderType providerType = ProviderType.Default)
        {
            ...
            try
            {
                ...
                if (avatarResult != null && avatarResult.Result != null && !avatarResult.IsError)
                {
                    ...
                    OASISResult<bool> writeOAPPSystemHolonDNAResult = await WriteDNAAsync(OAPPSystemHolonDNA, fullPathToT);
        ...
        protected virtual OASISResult<T1> Create(Guid avatarId, string name, string description, object holonSubType, string fullPathToT, Dictionary<string, object> metaData = null, ProviderType providerType = ProviderType.Default)
        {
            ...
            try
            {
                ...
                if (avatarResult != null && avatarResult.Result != null && !avatarResult.IsError)
                {
                    ...
                    OASISResult<bool> writeOAPPSystemHolonDNAResult = WriteDNA(OAPPSystemHolonDNA, fullPathToT);
        ...
        protected OASISResult<T1> Save(Guid avatarId, T1 holon, ProviderType providerType = ProviderType.Default)
        {
            OASISResult<T1> result = new OASISResult<T1>();
        ...
        protected async Task<OASISResult<T3>> SaveAsync(Guid avatarId, T3 holon, ProviderType providerType = ProviderType.Default)
        {
        ...
        protected OASISResult<T3> Save(Guid avatarId, T3 holon, ProviderType providerType = ProviderType.Default)
        {
            OASISResult<T3> result = new OASISResult<T3>();
        ...
        protected async Task<OASISResult<T1>> LoadAsync(Guid avatarId, Guid id, int version = 0, ProviderType providerType = ProviderType.Default)
        {
            OASISResult<T1> result = new OASISResult<T1>();
        ...
        protected OASISResult<T1> Load(Guid avatarId, Guid id, int version = 0, ProviderType providerType = ProviderType.Default)
        {
            OASISResult<T1> result = new OASISResult<T1>();
        ...
        protected async Task<OASISResult<IEnumerable<T1>>> LoadAllForAvatarAsync(Guid avatarId, bool showAllVersions = false, int version = 0, ProviderType providerType = ProviderType.Default)
        {
            OASISResult<IEnumerable<T1>> result = new OASISResult<IEnumerable<T1>>();
        ...
        protected OASISResult<IEnumerable<T1>> LoadAllForAvatar(Guid avatarId, bool showAllVersions = false, int version = 0, ProviderType providerType = ProviderType.Default)
        {
            OASISResult<IEnumerable<T1>> result = new OASISResult<IEnumerable<T1>>();
        ...
        protected async Task<OASISResult<IEnumerable<T1>>> SearchAsync(Guid avatarId, string searchTerm, HolonType holonType, bool searchOnlyForCurrentAvatar = true, bool showAllVersions = false, int version = 0, ProviderType providerType = ProviderType.Default)
        {
            OASISResult<IEnumerable<T1>> result = new OASISResult<IEnumerable<T1>>();
        ...
        protected OASISResult<IEnumerable<T1>> Search(Guid avatarId, string searchTerm, HolonType holonType, bool searchOnlyForCurrentAvatar = true, bool showAllVersions = false, int version = 0, ProviderType providerType = ProviderType.Default)
        {
            OASISResult<IEnumerable<T1>> result = new OASISResult<IEnumerable<T1>>();
        ...
        protected async Task<OASISResult<T1>> DeleteAsync(Guid avatarId, Guid id, int version, bool softDelete = true, bool deleteDownload = true, bool deleteInstall = true, ProviderType providerType = ProviderType.Default)
        {
            OASISResult<T1> result = new OASISResult<T1>();
        ...
        protected OASISResult<T1> Delete(Guid avatarId, Guid id, int version, bool softDelete = true, bool deleteDownload = true, bool deleteInstall = true, ProviderType providerType = ProviderType.Default)
        {
            OASISResult<T1> result = new OASISResult<T1>();
        ...
        protected async Task<OASISResult<T1>> DeleteAsync(Guid avatarId, IOAPPSystemHolon oappSystemHolon, int version, bool softDelete = true, bool deleteDownload = true, bool deleteInstall = true, ProviderType providerType = ProviderType.Default)
        {
            OASISResult<T1> result = new OASISResult<T1>();
            string errorMessage = "Error occured in DeleteAsync. Reason: ";
        ...
        protected OASISResult<T1> Delete(Guid avatarId, IOAPPSystemHolon oappSystemHolon, int version, bool softDelete = true, bool deleteDownload = true, bool deleteInstall = true, ProviderType providerType = ProviderType.Default)
        {
            OASISResult<T1> result = new OASISResult<T1>();
            string errorMessage = "Error occured in Delete. Reason: ";
            ...
            OASISResult<T1> deleteHolonResult = DeleteHolon<T1>(avatarId, oappSystemHolon.Id, softDelete, providerType, "OAPPSystemManagerBase.Delete");
        ...
        protected async Task<OASISResult<IOAPPSystemHolon>> PublishOAPPSystemHolonAsync(Guid OAPPSystemHolonId, Guid avatarId, ProviderType providerType = ProviderType.Default)
        {
        ...
        protected OASISResult<IOAPPSystemHolon> PublishOAPPSystemHolon(Guid OAPPSystemHolonId, Guid avatarId, ProviderType providerType = ProviderType.Default)
        {
            OASISResult<IOAPPSystemHolon> result = new OASISResult<IOAPPSystemHolon>();
        ...
        protected async Task<OASISResult<IOAPPSystemHolon>> PublishOAPPSystemHolonAsync(IOAPPSystemHolon T, Guid avatarId, ProviderType providerType = ProviderType.Default)
        {
            OASISResult<IOAPPSystemHolon> result = new OASISResult<IOAPPSystemHolon>();
        ...
        protected OASISResult<IOAPPSystemHolon> PublishOAPPSystemHolon(IOAPPSystemHolon T, Guid avatarId, ProviderType providerType = ProviderType.Default)
        {
            OASISResult<IOAPPSystemHolon> result = new OASISResult<IOAPPSystemHolon>();
        ...
        protected async Task<OASISResult<IOAPPSystemHolon>> UnpublishOAPPSystemHolonAsync(Guid OAPPSystemHolonId, Guid avatarId, ProviderType providerType = ProviderType.Default)
        {
            OASISResult<IOAPPSystemHolon> result = new OASISResult<IOAPPSystemHolon>();
        ...
        protected OASISResult<IOAPPSystemHolon> UnpublishOAPPSystemHolon(Guid OAPPSystemHolonId, Guid avatarId, ProviderType providerType = ProviderType.Default)
        {
            OASISResult<IOAPPSystemHolon> result = new OASISResult<IOAPPSystemHolon>();
        ...
        protected async Task<OASISResult<IOAPPSystemHolon>> UnpublishOAPPSystemHolonAsync(IOAPPSystemHolon T, Guid avatarId, ProviderType providerType = ProviderType.Default)
        {
            OASISResult<IOAPPSystemHolon> result = new OASISResult<IOAPPSystemHolon>();
        ...
        protected OASISResult<IOAPPSystemHolon> UnpublishOAPPSystemHolon(IOAPPSystemHolon T, Guid avatarId, ProviderType providerType = ProviderType.Default)
        {
            OASISResult<IOAPPSystemHolon> result = new OASISResult<IOAPPSystemHolon>();
        ...
        protected async Task<OASISResult<IEnumerable<T1>>> LoadVersionsAsync(Guid id, ProviderType providerType = ProviderType.Default)
        {
            OASISResult<IEnumerable<T1>> result = new OASISResult<IEnumerable<T1>>();
        ...
        protected OASISResult<IEnumerable<T1>> LoadVersions(Guid id, ProviderType providerType = ProviderType.Default)
        {
            OASISResult<IEnumerable<T1>> result = new OASISResult<IEnumerable<T1>>();
        ...
        protected async Task<OASISResult<T1>> LoadVersionAsync(Guid id, string version, ProviderType providerType = ProviderType.Default)
        {
            OASISResult<T1> result = new OASISResult<T1>();
        ...
        protected OASISResult<T1> LoadVersion(Guid id, string version, ProviderType providerType = ProviderType.Default)
        {
            OASISResult<T1> result = new OASISResult<T1>();
        ...
        //protected async Task<OASISResult<T1>> EditAsync<T1, T2>(Guid id, IOAPPSystemHolonDNA newOAPPSystemHolonDNA, Guid avatarId, ProviderType providerType = ProviderType.Default) where T1 : IOAPPSystemHolon, new() where T2 : IInstalledOAPPSystemHolon, new()
        //{
        //    OASISResult<T1> result = new OASISResult<T1>();
        ...
        protected async Task<OASISResult<T1>> EditAsync(Guid id, IOAPPSystemHolonDNA newOAPPSystemHolonDNA, Guid avatarId, ProviderType providerType = ProviderType.Default)
        {
            OASISResult<T1> result = new OASISResult<T1>();
            OASISResult<T1> loadResult = await LoadAsync(id, avatarId, providerType: providerType);

            if (loadResult != null && loadResult.Result != null && !loadResult.IsError)
                await EditAsync(avatarId, loadResult.Result, newOAPPSystemHolonDNA, providerType);
            else
                OASISErrorHandling.HandleError(ref result, $"Error occured in OAPPSystemManagerBase.EditAsync. Reason: {loadResult.Message}");
        ...
        protected async Task<OASISResult<T1>> EditAsync(Guid avatarId, T1 holon, IOAPPSystemHolonDNA newOAPPSystemHolonDNA, ProviderType providerType = ProviderType.Default)
        {
            OASISResult<T1> result = new OASISResult<T1>();
        ...
        //protected async Task<OASISResult<T1>> PublishAsync(Guid avatarId, string fullPathToSource, string launchTarget, string fullPathToPublishTo = "", bool edit = false, bool registerOnSTARNET = true, bool dotnetPublish = true, bool generateSource = true, bool uploadSourceToSTARNET = true, bool makeSourcePublic = false, bool generateBinary = true, bool generateSelfContainedBinary = false, bool generateSelfContainedFullBinary = false, bool uploadToCloud = false, bool uploadSelfContainedToCloud = false, bool uploadSelfContainedFullToCloud = false, ProviderType providerType = ProviderType.Default, ProviderType binaryProviderType = ProviderType.IPFSOASIS, ProviderType selfContainedBinaryProviderType = ProviderType.None, ProviderType selfContainedFullBinaryProviderType = ProviderType.None)
        {
            ...
            try
            {
                OASISResult<IOAPPSystemHolonDNA> readOAPPSystemHolonDNAResult = await ReadDNAFromSourceOrInstallFolderAsync<IOAPPSystemHolonDNA>(fullPathToSource);
                ...
                if (readOAPPSystemHolonDNAResult != null && !readOAPPSystemHolonDNAResult.IsError && readOAPPSystemHolonDNAResult.Result != null)
                {
                    ...
                    OnPublishStatusChanged?.Invoke(this, new OAPPSystemHolonPublishStatusEventArgs() { OAPPSystemHolonDNA = OAPPSystemHolonDNA, Status = Enums.OAPPSystemHolonPublishStatus.Packaging });
                        ...
                        if (loadOAPPSystemHolonResult != null && loadOAPPSystemHolonResult.Result != null && !loadOAPPSystemHolonResult.IsError)
                        {
                            if (loadOAPPSystemHolonResult.Result.OAPPSystemHolonDNA.CreatedByAvatarId == avatarId)
                            {
                                ...
                                if (validateVersionResult != null && validateVersionResult.Result && !validateVersionResult.IsError)
                                {
                                    ...
                                    WriteDNA(OAPPSystemHolonDNA, fullPathToSource);
                                    OnPublishStatusChanged?.Invoke(this, new OAPPSystemHolonPublishStatusEventArgs() { OAPPSystemHolonDNA = OAPPSystemHolonDNA, Status = Enums.OAPPSystemHolonPublishStatus.Compressing });
                                    ...
                                    if (saveOAPPSystemHolonResult != null && !saveOAPPSystemHolonResult.IsError && saveOAPPSystemHolonResult.Result != null)
                                    {
                                        ...
                                        OnPublishStatusChanged?.Invoke(this, new OAPPSystemHolonPublishStatusEventArgs() { OAPPSystemHolonDNA = OAPPSystemHolonDNA, Status = Enums.OAPPSystemHolonPublishStatus.Published });
                                    }
                                    else
        ...
        protected OASISResult<bool> GenerateCompressedFile(string sourcePath, string destinationPath)
        {
        ...
        protected OASISResult<T1> Publish(Guid avatarId, string fullPathToSource, string launchTarget, string fullPathToPublishTo = "", bool registerOnSTARNET = true, bool generateBinary = true, bool uploadToCloud = false, bool edit = false, ProviderType providerType = ProviderType.Default, ProviderType binaryProviderType = ProviderType.IPFSOASIS)
        {
            ...
            try
            {
                OASISResult<IOAPPSystemHolonDNA> readOAPPSystemHolonDNAResult = ReadDNAFromSourceOrInstallFolder<IOAPPSystemHolonDNA>(fullPathToSource);
                        ...
                        if (loadOAPPSystemHolonResult != null && loadOAPPSystemHolonResult.Result != null && !loadOAPPSystemHolonResult.IsError)
                        {
                            if (loadOAPPSystemHolonResult.Result.OAPPSystemHolonDNA.CreatedByAvatarId == avatarId)
                            {
                                ...
                                if (validateVersionResult != null && validateVersionResult.Result && !validateVersionResult.IsError)
                                {
                                    ...
                                    OASISResult<T1> saveOAPPSystemHolonResult = Save(avatarId, loadOAPPSystemHolonResult.Result, providerType);

                                    if (saveOAPPSystemHolonResult != null && !saveOAPPSystemHolonResult.IsError && saveOAPPSystemHolonResult.Result != null)
                                    {
                                        result = UpdateNumberOfVersionCounts(avatarId, saveOAPPSystemHolonResult, errorMessage, providerType);
                                        result.IsSaved = true;
        ...
        protected async Task<OASISResult<T1>> BeginPublishAsync(Guid avatarId, string fullPathToSource, string fullPathToPublishTo, string launchTarget, bool edit, ProviderType providerType)
        {
            OASISResult<T1> result = new OASISResult<T1>();
            ...
            try
            {
                OASISResult<IOAPPDNA> readOAPPSystemHolonDNAResult = await ReadDNAFromSourceOrInstallFolderAsync<IOAPPDNA>(fullPathToSource);

                if (readOAPPSystemHolonDNAResult != null && !readOAPPSystemHolonDNAResult.IsError && readOAPPSystemHolonDNAResult.Result != null)
                {
                    //OAPPDNA = readOAPPSystemHolonDNAResult.Result;
                    OnPublishStatusChanged?.Invoke(this, new OAPPSystemHolonPublishStatusEventArgs() { OAPPSystemHolonDNA = readOAPPSystemHolonDNAResult.Result, Status = Enums.OAPPSystemHolonPublishStatus.Packaging });
                    OASISResult<IAvatar> loadAvatarResult = await AvatarManager.Instance.LoadAvatarAsync(avatarId, false, true, providerType);
                    ...
                    if (loadAvatarResult != null && loadAvatarResult.Result != null && !loadAvatarResult.IsError)
                    {
                        ...
                        //Load latest version.
                        OASISResult<T1> loadOAPPResult = await LoadAsync(avatarId, readOAPPSystemHolonDNAResult.Result.Id);
                        ...
                        if (loadOAPPResult != null && loadOAPPResult.Result != null && !loadOAPPResult.IsError)
                        {
                            ...
                            {
                                OASISResult<bool> validateVersionResult = ValidateVersion(readOAPPSystemHolonDNAResult.Result.Version, loadOAPPResult.Result.OAPPSystemHolonDNA.Version, fullPathToSource, loadOAPPResult.Result.OAPPSystemHolonDNA.PublishedOn == DateTime.MinValue, edit);

                                if (validateVersionResult != null && validateVersionResult.Result && !validateVersionResult.IsError)
                                {
                                    //TODO: Maybe add check to make sure the DNA has not been tampered with?
                                    loadOAPPResult.Result.OAPPSystemHolonDNA.Version = readOAPPSystemHolonDNAResult.Result.Version; //Set the new version set in the DNA (JSON file).
                                    IOAPPDNA OAPPDNA = (IOAPPDNA)loadOAPPResult.Result.OAPPSystemHolonDNA; //Make sure it has not been tampered with by using the stored version.
                                    ...
                                    result.Result.OAPPSystemHolonDNA = OAPPDNA;
                                }
                            }
                        }
                    }
            ...
            {
                OASISErrorHandling.HandleError(ref result, $"Error occured in OAPPSystemManagerBase.BeginPublishAsync. Reason: {e.Message}");
            }

            return result;
        }

        protected OASISResult<T1> BeginPublish(Guid avatarId, string fullPathToSource, string fullPathToPublishTo, string launchTarget, bool edit, ProviderType providerType)
        {
            OASISResult<T1> result = new OASISResult<T1>();
            string userName = "Unknown";
            ...
            try
            {
                OASISResult<IOAPPDNA> readOAPPSystemHolonDNAResult = ReadDNAFromSourceOrInstallFolder<IOAPPDNA>(fullPathToSource);
                ...
                if (readOAPPSystemHolonDNAResult != null && !readOAPPSystemHolonDNAResult.IsError && readOAPPSystemHolonDNAResult.Result != null)
                {
                    ...
                    if (loadAvatarResult != null && loadAvatarResult.Result != null && !loadAvatarResult.IsError)
                    {
                        ...
                        //Load latest version.
                        OASISResult<T1> loadOAPPResult = Load(avatarId, readOAPPSystemHolonDNAResult.Result.Id);
            ...
            {
                OASISErrorHandling.HandleError(ref result, $"Error occured in OAPPSystemManagerBase.BeginPublish. Reason: {e.Message}");
            }
        ...
        protected async Task<OASISResult<T>> UploadToCloudAsync<T>(IOAPPSystemHolonDNA OAPPSystemHolonDNA, string publishedOAPPSystemHolonFileName, bool registerOnSTARNET, ProviderType binaryProviderType)
        {
            ...
            try
            {
                OnPublishStatusChanged?.Invoke(this, new OAPPSystemHolonPublishStatusEventArgs() { OAPPSystemHolonDNA = OAPPSystemHolonDNA, Status = Enums.OAPPSystemHolonPublishStatus.Uploading });
                ...
                _progress = 100;
                OnUploadStatusChanged?.Invoke(this, new OAPPSystemHolonUploadProgressEventArgs() { Progress = _progress, Status = Enums.OAPPSystemHolonUploadStatus.Uploading });
        ...
        protected async Task<OASISResult<T1>> UploadToOASISAsync(Guid avatarId, IOAPPSystemHolonDNA OAPPSystemHolonDNA, string publishedPath, bool registerOnSTARNET, bool uploadToCloud, ProviderType binaryProviderType)
        {
            OASISResult<T1> result = new OASISResult<T1>();

            result.Result.PublishedOAPPSystemHolon = File.ReadAllBytes(publishedPath);

            //TODO: We could use HoloOASIS and other large file storage providers in future...
            OASISResult<T1> saveLargeOAPPSystemHolonResult = await SaveAsync(avatarId, result.Result, binaryProviderType);
        ...
        protected OASISResult<T1> UploadToOASIS(Guid avatarId, IOAPPSystemHolonDNA OAPPSystemHolonDNA, string publishedPath, bool registerOnSTARNET, bool uploadToCloud, ProviderType binaryProviderType)
        {
            OASISResult<T1> result = new OASISResult<T1>();
            ...
            //TODO: We could use HoloOASIS and other large file storage providers in future...
            OASISResult<T1> saveLargeOAPPSystemHolonResult = Save(avatarId, result.Result, binaryProviderType);
        ...
        protected async Task<OASISResult<T1>> FininalizePublishAsync(Guid avatarId, T1 holon, bool edit, ProviderType providerType)
        {
            OASISResult<T1> result = new OASISResult<T1>();
            string errorMessage = "";

            //If its not the first version.
            if (holon.OAPPSystemHolonDNA.Version != "1.0.0" && !edit)
            {
                //If the ID has not been set then store the original id now.
                if (!holon.MetaData.ContainsKey(OAPPSystemHolonIdName))
                    holon.MetaData[OAPPSystemHolonIdName] = holon.Id;

                holon.MetaData["Version"] = holon.OAPPSystemHolonDNA.Version;
                holon.MetaData["VersionSequence"] = holon.OAPPSystemHolonDNA.VersionSequence;
                ...
                holon.OAPPSystemHolonDNA.Downloads = 0;
                holon.OAPPSystemHolonDNA.Installs = 0;
            }

            OASISResult<T1> saveOAPPSystemHolonResult = await SaveAsync(avatarId, holon, providerType);
            ...
            if (saveOAPPSystemHolonResult != null && !saveOAPPSystemHolonResult.IsError && saveOAPPSystemHolonResult.Result != null)
            {
                ...
                if (holon.OAPPSystemHolonDNA.STARODKVersion != OASISBootLoader.OASISBootLoader.STARODKVersion)
                    OASISErrorHandling.HandleWarning(ref result, $" The STAR ODK Version {holon.OAPPSystemHolonDNA.STARODKVersion} does not match the current version {OASISBootLoader.OASISBootLoader.STARODKVersion}. This may lead to issues, it is recommended to make sure the versions match.");

                if (holon.OAPPSystemHolonDNA.OASISVersion != OASISBootLoader.OASISBootLoader.OASISVersion)
                    OASISErrorHandling.HandleWarning(ref result, $" The OASIS Version {holon.OAPPSystemHolonDNA.OASISVersion} does not match the current version {OASISBootLoader.OASISBootLoader.OASISVersion}. This may lead to issues, it is recommended to make sure the versions match.");

                if (holon.OAPPSystemHolonDNA.COSMICVersion != OASISBootLoader.OASISBootLoader.COSMICVersion)
                    OASISErrorHandling.HandleWarning(ref result, $" The COSMIC Version {holon.OAPPSystemHolonDNA.COSMICVersion} does not match the current version {OASISBootLoader.OASISBootLoader.COSMICVersion}. This may lead to issues, it is recommended to make sure the versions match.");
                ...
                OnPublishStatusChanged?.Invoke(this, new OAPPSystemHolonPublishStatusEventArgs() { OAPPSystemHolonDNA = holon.OAPPSystemHolonDNA, Status = Enums.OAPPSystemHolonPublishStatus.Published });
            }
            else
                OASISErrorHandling.HandleError(ref result, $"{errorMessage} Error occured calling SaveOAPPSystemHolonAsync on {Enum.GetName(typeof(ProviderType), providerType)} provider. Reason: {saveOAPPSystemHolonResult.Message}");
        ...
        protected OASISResult<T1> FininalizePublish(Guid avatarId, T1 holon, bool edit, ProviderType providerType)
        {
            OASISResult<T1> result = new OASISResult<T1>();
            string errorMessage = "";
            ...
            OASISResult<T1> saveOAPPSystemHolonResult = Save(avatarId, holon, providerType);

            if (saveOAPPSystemHolonResult != null && !saveOAPPSystemHolonResult.IsError && saveOAPPSystemHolonResult.Result != null)
            {
                saveOAPPSystemHolonResult = UpdateNumberOfVersionCounts(avatarId, saveOAPPSystemHolonResult, errorMessage, providerType);
                result.IsSaved = true;
                result.Result = saveOAPPSystemHolonResult.Result; //TODO:Check if this is needed?
        ...
        protected OASISResult<T1> Unpublish(Guid avatarId, T1 holon, ProviderType providerType = ProviderType.Default)
        {
            OASISResult<T1> result = new OASISResult<T1>();
        ...
        protected async Task<OASISResult<T1>> UnpublishAsync(Guid avatarId, Guid OAPPSystemHolonId, int version, ProviderType providerType = ProviderType.Default)
        {
            OASISResult<T1> result = new OASISResult<T1>();
        ...
        protected OASISResult<T1> Unpublish(Guid avatarId, Guid OAPPSystemHolonId, int version, ProviderType providerType = ProviderType.Default)
        {
            OASISResult<T1> result = new OASISResult<T1>();
        ...
        protected async Task<OASISResult<T1>> UnpublishAsync(Guid avatarId, IOAPPSystemHolonDNA OAPPSystemHolonDNA, ProviderType providerType = ProviderType.Default)
        {
            OASISResult<T1> result = new OASISResult<T1>();
        ...
        protected OASISResult<T1> Unpublish(Guid avatarId, IOAPPSystemHolonDNA OAPPSystemHolonDNA, ProviderType providerType = ProviderType.Default)
        {
            OASISResult<T1> result = new OASISResult<T1>();
        ...
        protected async Task<OASISResult<T1>> RepublishAsync(Guid avatarId, T1 holon, ProviderType providerType = ProviderType.Default)
        {
            OASISResult<T1> result = new OASISResult<T1>();
        ...
        protected OASISResult<T1> Republish(Guid avatarId, T1 holon, ProviderType providerType = ProviderType.Default)
        {
            OASISResult<T1> result = new OASISResult<T1>();
        ...
        protected async Task<OASISResult<T1>> RepublishAsync(Guid avatarId, IOAPPSystemHolonDNA OAPPSystemHolonDNA, ProviderType providerType = ProviderType.Default)
        {
            OASISResult<T1> result = new OASISResult<T1>();
            OASISResult<T1> oappResult = await LoadAsync(OAPPSystemHolonDNA.Id, avatarId, OAPPSystemHolonDNA.VersionSequence, providerType);
            string errorMessage = "Error occured in RepublishAsync. Reason: ";
        ...
        protected OASISResult<T1> Republish(Guid avatarId, IOAPPSystemHolonDNA OAPPSystemHolonDNA, ProviderType providerType = ProviderType.Default)
        {
            OASISResult<T1> result = new OASISResult<T1>();
            OASISResult<T1> oappResult = Load(OAPPSystemHolonDNA.Id, avatarId, OAPPSystemHolonDNA.VersionSequence, providerType);
            string errorMessage = "Error occured in Republish. Reason: ";
        ...
        protected async Task<OASISResult<T1>> RepublishAsync(Guid avatarId, Guid OAPPSystemHolonId, int version, ProviderType providerType = ProviderType.Default)
        {
            OASISResult<T1> result = new OASISResult<T1>();
            OASISResult<T1> loadResult = await LoadAsync(OAPPSystemHolonId, avatarId, version, providerType);
        ...
        protected OASISResult<T1> Republish(Guid avatarId, Guid OAPPSystemHolonId, int version, ProviderType providerType = ProviderType.Default)
        {
            OASISResult<T1> result = new OASISResult<T1>();
            OASISResult<T1> loadResult = Load(OAPPSystemHolonId, avatarId, version, providerType);
        ...
        protected async Task<OASISResult<T1>> DeactivateAsync(Guid avatarId, T1 holon, ProviderType providerType = ProviderType.Default)
        {
            OASISResult<T1> result = new OASISResult<T1>();
        ...
        protected OASISResult<T1> Deactivate(Guid avatarId, T1 holon, ProviderType providerType = ProviderType.Default)
        {
            OASISResult<T1> result = new OASISResult<T1>();
        ...
        protected async Task<OASISResult<T1>> DeactivateAsync(Guid avatarId, Guid OAPPSystemHolonId, int version, ProviderType providerType = ProviderType.Default)
        {
            OASISResult<T1> result = new OASISResult<T1>();
            OASISResult<T1> loadResult = await LoadAsync(OAPPSystemHolonId, avatarId, version, providerType);
        ...
        protected OASISResult<T1> Deactivate(Guid avatarId, Guid OAPPSystemHolonId, int version, ProviderType providerType = ProviderType.Default)
        {
            OASISResult<T1> result = new OASISResult<T1>();
            OASISResult<T1> loadResult = Load(OAPPSystemHolonId, avatarId, version, providerType);
        ...
        protected async Task<OASISResult<T1>> DeactivateAsync(Guid avatarId, IOAPPSystemHolonDNA OAPPSystemHolonDNA, ProviderType providerType = ProviderType.Default)
        {
            OASISResult<T1> result = new OASISResult<T1>();
            OASISResult<T1> oappResult = await LoadAsync(OAPPSystemHolonDNA.Id, avatarId, OAPPSystemHolonDNA.VersionSequence, providerType);
            string errorMessage = "Error occured in DeactivateAsync. Reason: ";
        ...
        protected OASISResult<T1> Deactivate(Guid avatarId, IOAPPSystemHolonDNA OAPPSystemHolonDNA, ProviderType providerType = ProviderType.Default)
        {
            OASISResult<T1> result = new OASISResult<T1>();
            OASISResult<T1> oappResult = Load(OAPPSystemHolonDNA.Id, avatarId, OAPPSystemHolonDNA.VersionSequence, providerType);
            string errorMessage = "Error occured in Deactivate. Reason: ";
        ...
        protected async Task<OASISResult<T1>> ActivateAsync(T1 holon, Guid avatarId, ProviderType providerType = ProviderType.Default)
        {
            OASISResult<T1> result = new OASISResult<T1>();
        ...
        protected OASISResult<T1> Activate(T1 holon, Guid avatarId, ProviderType providerType = ProviderType.Default)
        {
            OASISResult<T1> result = new OASISResult<T1>();
        ...
        protected async Task<OASISResult<T1>> ActivateAsync(IOAPPSystemHolonDNA OAPPSystemHolonDNA, Guid avatarId, ProviderType providerType = ProviderType.Default)
        {
            OASISResult<T1> result = new OASISResult<T1>();
            OASISResult<T1> oappResult = await LoadAsync(OAPPSystemHolonDNA.Id, avatarId, OAPPSystemHolonDNA.VersionSequence, providerType);
            string errorMessage = "Error occured in ActivateAsync. Reason: ";
        ...
        protected OASISResult<T1> Activate(Guid avatarId, IOAPPSystemHolonDNA OAPPSystemHolonDNA, ProviderType providerType = ProviderType.Default)
        {
            OASISResult<T1> result = new OASISResult<T1>();
            OASISResult<T1> oappResult = Load(OAPPSystemHolonDNA.Id, avatarId, OAPPSystemHolonDNA.VersionSequence, providerType);
            string errorMessage = "Error occured in Activate. Reason: ";
        ...
        protected async Task<OASISResult<T1>> ActivateAsync(Guid avatarId, Guid id, int version, ProviderType providerType = ProviderType.Default)
        {
            OASISResult<T1> result = new OASISResult<T1>();
            OASISResult<T1> loadResult = await LoadAsync(id, avatarId, version, providerType);
        ...
        protected OASISResult<T1> Activate(Guid avatarId, Guid id, int version, ProviderType providerType = ProviderType.Default)
        {
            OASISResult<T1> result = new OASISResult<T1>();
            OASISResult<T1> loadResult = Load(id, avatarId, version, providerType);
        ...
        protected async Task<OASISResult<T2>> DownloadAsync(Guid avatarId, T1 holon, string fullDownloadPath, bool reInstall = false, ProviderType providerType = ProviderType.Default)
        {
            ...
            try
            {
                ...
                try
                {
                    ...
                    using (var fileStream = File.OpenWrite(fullDownloadPath))
                    {
                        ...
                        OnInstallStatusChanged?.Invoke(this, new OAPPSystemHolonInstallStatusEventArgs() { OAPPSystemHolonDNA = holon.OAPPSystemHolonDNA, Status = Enums.OAPPSystemHolonInstallStatus.Downloading });
                        ...
                        _progress = 100;
                        OnDownloadStatusChanged?.Invoke(this, new OAPPSystemHolonDownloadProgressEventArgs() { Progress = _progress, Status = Enums.OAPPSystemHolonDownloadStatus.Downloading });
                        CLIEngine.DisposeProgressBar(false);
                        Console.WriteLine("");
                        fileStream.Close();
                    }
        ...
        protected OASISResult<T2> Download(Guid avatarId, T1 holon, string fullDownloadPath, bool reInstall = false, ProviderType providerType = ProviderType.Default)
        {
            OASISResult<T2> result = new OASISResult<T2>();
        ...
        protected async Task<OASISResult<T3>> DownloadAndInstallAsync(Guid avatarId, T1 holon, string fullInstallPath, string fullDownloadPath = "", bool createOAPPSystemHolonDirectory = true, bool reInstall = false, ProviderType providerType = ProviderType.Default)
        {
            OASISResult<T3> result = new OASISResult<T3>();
            ...
            if (result.IsError)
                OnInstallStatusChanged?.Invoke(this, new OAPPSystemHolonInstallStatusEventArgs() { OAPPSystemHolonDNA = holon.OAPPSystemHolonDNA, Status = Enums.OAPPSystemHolonInstallStatus.Error, ErrorMessage = result.Message });

            return result;
        }

        //copied.
        protected OASISResult<T3> DownloadAndInstall(Guid avatarId, T1 holon, string fullInstallPath, string fullDownloadPath = "", bool createOAPPSystemHolonDirectory = true, bool reInstall = false, ProviderType providerType = ProviderType.Default)
        {
            OASISResult<T3> result = new OASISResult<T3>();
        ...
        protected async Task<OASISResult<T3>> DownloadAndInstallAsync(Guid avatarId, Guid OAPPSystemHolonId, int version, string fullInstallPath, string fullDownloadPath = "", bool createOAPPSystemHolonDirectory = true, bool reInstall = false, ProviderType providerType = ProviderType.Default)
        {
            OASISResult<T3> result = new OASISResult<T3>();
            ...
            else
            {
                ...
                OnInstallStatusChanged?.Invoke(this, new OAPPSystemHolonInstallStatusEventArgs() { Status = Enums.OAPPSystemHolonInstallStatus.Error, ErrorMessage = result.Message });
            }
        ...
        //copied.
        protected OASISResult<T3> DownloadAndInstall(Guid avatarId, Guid OAPPSystemHolonId, int version, string fullInstallPath, string fullDownloadPath = "", bool createOAPPSystemHolonDirectory = true, bool reInstall = false, ProviderType providerType = ProviderType.Default)
        {
            OASISResult<T3> result = new OASISResult<T3>();
        ...
        protected async Task<OASISResult<T3>> InstallAsync(Guid avatarId, string fullPathToPublishedOAPPSystemHolonFile, string fullInstallPath, bool createOAPPSystemHolonDirectory = true, IDownloadedOAPPSystemHolon downloadedOAPPSystemHolon = null, bool reInstall = false, ProviderType providerType = ProviderType.Default)
        {
            OASISResult<T3> result = new OASISResult<T3>();
            ...
            try
            {
                ...
                //Unzip
                OnInstallStatusChanged?.Invoke(this, new OAPPSystemHolonInstallStatusEventArgs() { Status = Enums.OAPPSystemHolonInstallStatus.Decompressing });
                ZipFile.ExtractToDirectory(fullPathToPublishedOAPPSystemHolonFile, tempPath, Encoding.Default, true);
                OASISResult<IOAPPSystemHolonDNA> OAPPSystemHolonDNAResult = await ReadDNAFromSourceOrInstallFolderAsync<IOAPPSystemHolonDNA>(tempPath);
                ...
                if (OAPPSystemHolonDNAResult != null && OAPPSystemHolonDNAResult.Result != null && !OAPPSystemHolonDNAResult.IsError)
                {
                    ...
                    if (OAPPSystemHolonLoadResult != null && OAPPSystemHolonLoadResult.Result != null && !OAPPSystemHolonLoadResult.IsError)
                    {
                        ...
                        OnInstallStatusChanged?.Invoke(this, new OAPPSystemHolonInstallStatusEventArgs() { OAPPSystemHolonDNA = OAPPSystemHolonDNAResult.Result, Status = Enums.OAPPSystemHolonInstallStatus.Installing });
                        OASISResult<IAvatar> avatarResult = await AvatarManager.Instance.LoadAvatarAsync(avatarId, false, true, providerType);
                        ...
                        if (avatarResult != null && !avatarResult.IsError && avatarResult.Result != null)
                        {
                            ...
                            if (!result.IsError)
                            {
                                OASISResult<T3> saveResult = await SaveAsync(avatarId, installedOAPPSystemHolon, providerType);
                                ...
                                if (saveResult != null && saveResult.Result != null && !saveResult.IsError)
                                {
                                    ...
                                    OASISResult<T1> oappSaveResult = await SaveAsync(avatarId, OAPPSystemHolonLoadResult.Result, providerType);
                                    ...
                                    if (oappSaveResult != null && !oappSaveResult.IsError && oappSaveResult.Result != null)
                                    {
                                        ...
                                        result.Result = installedOAPPSystemHolon;
                                        OnInstallStatusChanged?.Invoke(this, new OAPPSystemHolonInstallStatusEventArgs() { OAPPSystemHolonDNA = OAPPSystemHolonDNAResult.Result, Status = Enums.OAPPSystemHolonInstallStatus.Installed });
                                    }
                                    else
            ...
            if (result.IsError)
                OnInstallStatusChanged?.Invoke(this, new OAPPSystemHolonInstallStatusEventArgs() { OAPPSystemHolonDNA = OAPPSystemHolonDNA, Status = Enums.OAPPSystemHolonInstallStatus.Error, ErrorMessage = result.Message });

            return result;
        }

        //Copied from async
        protected OASISResult<T3> Install(Guid avatarId, string fullPathToPublishedOAPPSystemHolonFile, string fullInstallPath, bool createOAPPSystemHolonDirectory = true, IDownloadedOAPPSystemHolon downloadedOAPPSystemHolon = null, bool reInstall = false, ProviderType providerType = ProviderType.Default)
        {
            OASISResult<T3> result = new OASISResult<T3>();
            ...
            try
            {
                ...
                OnInstallStatusChanged?.Invoke(this, new OAPPSystemHolonInstallStatusEventArgs() { Status = Enums.OAPPSystemHolonInstallStatus.Decompressing });
                ZipFile.ExtractToDirectory(fullPathToPublishedOAPPSystemHolonFile, tempPath, Encoding.Default, true);
                OASISResult<IOAPPSystemHolonDNA> OAPPSystemHolonDNAResult = ReadDNAFromSourceOrInstallFolder<IOAPPSystemHolonDNA>(tempPath);
                ...
                if (OAPPSystemHolonDNAResult != null && OAPPSystemHolonDNAResult.Result != null && !OAPPSystemHolonDNAResult.IsError)
                {
                    ...
                    if (OAPPSystemHolonLoadResult != null && OAPPSystemHolonLoadResult.Result != null && !OAPPSystemHolonLoadResult.IsError)
                    {
                        ...
                        if (avatarResult != null && !avatarResult.IsError && avatarResult.Result != null)
                        {
                            ...
                            if (!result.IsError)
                            {
                                OASISResult<T3> saveResult = Save(avatarId, installedOAPPSystemHolon, providerType);
                                ...
                                if (saveResult != null && saveResult.Result != null && !saveResult.IsError)
                                {
                                    ...
                                    OASISResult<T1> oappSaveResult = Save(avatarId, OAPPSystemHolonLoadResult.Result, providerType);
        ...
        //protected OASISResult<T3> Install(Guid avatarId, T1 holon, string fullInstallPath, string fullDownloadPath = "", bool createOAPPSystemHolonDirectory = true, ProviderType providerType = ProviderType.Default)
        //{
        //    OASISResult<T3> result = new OASISResult<T3>();
        //    string errorMessage = "Error occured in OAPPSystemManagerBase.Install. Reason: ";
        ...
        protected async Task<OASISResult<T3>> UninstallAsync(Guid avatarId, T3 installedOAPPSystemHolon, string errorMessage, ProviderType providerType)
        {
            OASISResult<T3> result = new OASISResult<T3>();
        ...
        //copied.
        protected OASISResult<T3> Uninstall(Guid avatarId, T3 installedOAPPSystemHolon, string errorMessage, ProviderType providerType)
        {
            OASISResult<T3> result = new OASISResult<T3>();
        ...
        protected async Task<OASISResult<T3>> UninstallAsync(Guid avatarId, Guid OAPPSystemHolonId, int versionSequence, ProviderType providerType = ProviderType.Default)
        {
            OASISResult<T3> result = new OASISResult<T3>();
        ...
        protected OASISResult<T3> Uninstall(Guid avatarId, Guid OAPPSystemHolonId, int versionSequence, ProviderType providerType = ProviderType.Default)
        {
            OASISResult<T3> result = new OASISResult<T3>();
            string errorMessage = "Error occured in OAPPSystemManagerBase.UninstallAsync. Reason: ";
        ...
        protected async Task<OASISResult<T3>> UninstallAsync(Guid avatarId, Guid OAPPSystemHolonId, string version, ProviderType providerType = ProviderType.Default)
        {
            OASISResult<T3> result = new OASISResult<T3>();
            string errorMessage = "Error occured in OAPPSystemManagerBase.UninstallAsync. Reason: ";
        ...
        protected OASISResult<T3> Uninstall(Guid avatarId, Guid OAPPSystemHolonId, string version, ProviderType providerType = ProviderType.Default)
        {
            OASISResult<T3> result = new OASISResult<T3>();
        ...
        protected async Task<OASISResult<T3>> UninstallAsync(Guid avatarId, string OAPPSystemHolonName, int versionSequence, ProviderType providerType = ProviderType.Default)
        {
            OASISResult<T3> result = new OASISResult<T3>();
            string errorMessage = "Error occured in OAPPSystemManagerBase.UninstallAsync. Reason: ";
        ...
        protected OASISResult<T3> Uninstall(Guid avatarId, string OAPPSystemHolonName, int versionSequence, ProviderType providerType = ProviderType.Default)
        {
            OASISResult<T3> result = new OASISResult<T3>();
            string errorMessage = "Error occured in OAPPSystemManagerBase.Uninstall. Reason: ";
        ...
        protected async Task<OASISResult<T3>> UninstallAsync(Guid avatarId, string OAPPSystemHolonName, string version, ProviderType providerType = ProviderType.Default)
        {
            OASISResult<T3> result = new OASISResult<T3>();
            string errorMessage = "Error occured in OAPPSystemManagerBase.UninstallAsync. Reason: ";
        ...
        protected OASISResult<T3> Uninstall(Guid avatarId, string OAPPSystemHolonName, string version, ProviderType providerType = ProviderType.Default)
        {
            OASISResult<T3> result = new OASISResult<T3>();
            string errorMessage = "Error occured in OAPPSystemManagerBase.Uninstall. Reason: ";
        ...
        protected async Task<OASISResult<IEnumerable<T3>>> ListInstalledAsync(Guid avatarId, ProviderType providerType = ProviderType.Default)
        {
        ...
        protected OASISResult<IEnumerable<T3>> ListInstalled(Guid avatarId, ProviderType providerType = ProviderType.Default)
        {
        ...
        protected async Task<OASISResult<IEnumerable<T3>>> ListUninstalledAsync(Guid avatarId, ProviderType providerType = ProviderType.Default)
        {
            OASISResult<IEnumerable<T3>> result = await Data.LoadHolonsForParentAsync<T3>(avatarId, OAPPSystemInstalledHolonType, false, false, 0, true, false, 0, HolonType.All, 0, providerType);
        ...
        protected OASISResult<IEnumerable<T3>> ListUninstalled(Guid avatarId, ProviderType providerType = ProviderType.Default)
        {
            OASISResult<IEnumerable<T3>> result = Data.LoadHolonsForParent<T3>(avatarId, OAPPSystemInstalledHolonType, false, false, 0, true, false, 0, HolonType.All, 0, providerType);
        ...
        protected async Task<OASISResult<IEnumerable<T1>>> ListUnpublishedAsync(Guid avatarId, ProviderType providerType = ProviderType.Default)
        {
            OASISResult<IEnumerable<T1>> result = new OASISResult<IEnumerable<T1>>();
        ...
        protected OASISResult<IEnumerable<T1>> ListUnpublished(Guid avatarId, ProviderType providerType = ProviderType.Default)
        {
            OASISResult<IEnumerable<T1>> result = new OASISResult<IEnumerable<T1>>();
        ...
        protected async Task<OASISResult<IEnumerable<T1>>> ListDeactivatedAsync(Guid avatarId, ProviderType providerType = ProviderType.Default)
        {
            OASISResult<IEnumerable<T1>> result = new OASISResult<IEnumerable<T1>>();
        ...
        protected OASISResult<IEnumerable<T1>> ListDeactivated(Guid avatarId, ProviderType providerType = ProviderType.Default)
        {
            OASISResult<IEnumerable<T1>> result = new OASISResult<IEnumerable<T1>>();
        ...
        protected OASISResult<bool> IsInstalled(Guid avatarId, Guid OAPPSystemHolonId, int versionSequence, ProviderType providerType = ProviderType.Default)
        {
            OASISResult<bool> result = new OASISResult<bool>();
        ...
        protected async Task<OASISResult<bool>> IsInstalledAsync(Guid avatarId, Guid OAPPSystemHolonId, string version, ProviderType providerType = ProviderType.Default)
        {
            OASISResult<bool> result = new OASISResult<bool>();
            string errorMessage = "Error occured in OAPPSystemManagerBase.IsInstalledAsync. Reason: ";
        ...
        protected OASISResult<bool> IsInstalled(Guid avatarId, Guid OAPPSystemHolonId, string version, ProviderType providerType = ProviderType.Default)
        {
            OASISResult<bool> result = new OASISResult<bool>();
            string errorMessage = "Error occured in OAPPSystemManagerBase.IsInstalled. Reason: ";
        ...
        protected async Task<OASISResult<bool>> IsInstalledAsync(Guid avatarId, string name, int versionSequence, ProviderType providerType = ProviderType.Default)
        {
            OASISResult<bool> result = new OASISResult<bool>();
            string errorMessage = "Error occured in OAPPSystemManagerBase.IsInstalledAsync. Reason: ";
        ...
        protected OASISResult<bool> IsInstalled(Guid avatarId, string name, int versionSequence, ProviderType providerType = ProviderType.Default)
        {
            OASISResult<bool> result = new OASISResult<bool>();
            string errorMessage = "Error occured in OAPPSystemManagerBase.IsInstalled. Reason: ";
        ...
        protected async Task<OASISResult<bool>> IsInstalledAsync(Guid avatarId, string name, string version, ProviderType providerType = ProviderType.Default)
        {
            OASISResult<bool> result = new OASISResult<bool>();
            string errorMessage = "Error occured in OAPPSystemManagerBase.IsInstalledAsync. Reason: ";
        ...
        protected OASISResult<bool> IsInstalled(Guid avatarId, string name, string version, ProviderType providerType = ProviderType.Default)
        {
            OASISResult<bool> result = new OASISResult<bool>();
            string errorMessage = "Error occured in OAPPSystemManagerBase.IsInstalled. Reason: ";
        ...
        protected async Task<OASISResult<T3>> LoadInstalledAsync(Guid avatarId, Guid OAPPSystemHolonId, int versionSequence = 0, ProviderType providerType = ProviderType.Default)
        {
            OASISResult<T3> result = new OASISResult<T3>();
        ...
        protected OASISResult<T3> LoadInstalled(Guid avatarId, Guid OAPPSystemHolonId, int versionSequence = 0, ProviderType providerType = ProviderType.Default)
        {
            OASISResult<T3> result = new OASISResult<T3>();
        ...
        protected async Task<OASISResult<T3>> LoadInstalledAsync(Guid avatarId, string name, int versionSequence = 0, ProviderType providerType = ProviderType.Default)
        {
            OASISResult<T3> result = new OASISResult<T3>();
            string errorMessage = "Error occured in OAPPSystemManagerBase.LoadInstalledAsync. Reason: ";
            OASISResult<T3> installedOAPPSystemHolonsResult = await Data.LoadHolonByMetaDataAsync<T3>(new Dictionary<string, string>()
        ...
        protected OASISResult<T3> LoadInstalled(Guid avatarId, string name, int versionSequence = 0, ProviderType providerType = ProviderType.Default)
        {
            OASISResult<T3> result = new OASISResult<T3>();
            string errorMessage = "Error occured in OAPPSystemManagerBase.LoadInstalled. Reason: ";
            OASISResult<T3> installedOAPPSystemHolonsResult = Data.LoadHolonByMetaData<T3>(new Dictionary<string, string>()
        ...
        protected async Task<OASISResult<T3>> LoadInstalledAsync(Guid avatarId, Guid OAPPSystemHolonId, string version, ProviderType providerType = ProviderType.Default)
        {
            OASISResult<T3> result = new OASISResult<T3>();
            string errorMessage = "Error occured in OAPPSystemManagerBase.LoadInstalledAsync. Reason: ";
            OASISResult<T3> installedOAPPSystemHolonsResult = await Data.LoadHolonByMetaDataAsync<T3>(new Dictionary<string, string>()
        ...
        protected OASISResult<T3> LoadInstalled(Guid avatarId, Guid OAPPSystemHolonId, string version, ProviderType providerType = ProviderType.Default)
        {
            OASISResult<T3> result = new OASISResult<T3>();
            string errorMessage = "Error occured in OAPPSystemManagerBase.LoadInstalled. Reason: ";
            OASISResult<T3> installedOAPPSystemHolonsResult = Data.LoadHolonByMetaData<T3>(new Dictionary<string, string>()
        ...
        protected async Task<OASISResult<T3>> LoadInstalledAsync(Guid avatarId, string name, string version, ProviderType providerType = ProviderType.Default)
        {
            OASISResult<T3> result = new OASISResult<T3>();
            string errorMessage = "Error occured in OAPPSystemManagerBase.LoadInstalledAsync. Reason: ";
            OASISResult<T3> installedOAPPSystemHolonsResult = await Data.LoadHolonByMetaDataAsync<T3>(new Dictionary<string, string>()
        ...
        protected OASISResult<T3> LoadInstalled(Guid avatarId, string name, string version, ProviderType providerType = ProviderType.Default)
        {
            OASISResult<T3> result = new OASISResult<T3>();
            string errorMessage = "Error occured in OAPPSystemManagerBase.LoadInstalled. Reason: ";
            OASISResult<T3> installedOAPPSystemHolonsResult = Data.LoadHolonByMetaData<T3>(new Dictionary<string, string>()
        ...
        protected async Task<OASISResult<T3>> LoadInstalledAsync(Guid avatarId, Guid OAPPSystemHolonId, bool active, int versionSequence = 0, ProviderType providerType = ProviderType.Default)
        {
            OASISResult<T3> result = new OASISResult<T3>();
            string errorMessage = "Error occured in OAPPSystemManagerBase.LoadInstalledAsync. Reason: ";
            OASISResult<T3> installedOAPPSystemHolonsResult = await Data.LoadHolonByMetaDataAsync<T3>(new Dictionary<string, string>()
        ...
        protected OASISResult<T3> LoadInstalled(Guid avatarId, Guid OAPPSystemHolonId, bool active, int versionSequence = 0, ProviderType providerType = ProviderType.Default)
        {
            OASISResult<T3> result = new OASISResult<T3>();
            string errorMessage = "Error occured in OAPPSystemManagerBase.LoadInstalled. Reason: ";
            OASISResult<T3> installedOAPPSystemHolonsResult = Data.LoadHolonByMetaData<T3>(new Dictionary<string, string>()
        ...
        protected async Task<OASISResult<T3>> LoadInstalledAsync(Guid avatarId, string name, bool active, int versionSequence = 0, ProviderType providerType = ProviderType.Default)
        {
            OASISResult<T3> result = new OASISResult<T3>();
            string errorMessage = "Error occured in OAPPSystemManagerBase.LoadInstalledAsync. Reason: ";
            OASISResult<T3> installedOAPPSystemHolonsResult = await Data.LoadHolonByMetaDataAsync<T3>(new Dictionary<string, string>()
        ...
        protected OASISResult<T3> LoadInstalled(Guid avatarId, string name, bool active, int versionSequence = 0, ProviderType providerType = ProviderType.Default)
        {
            OASISResult<T3> result = new OASISResult<T3>();
            string errorMessage = "Error occured in OAPPSystemManagerBase.LoadInstalled. Reason: ";
            OASISResult<T3> installedOAPPSystemHolonsResult = Data.LoadHolonByMetaData<T3>(new Dictionary<string, string>()
        ...
        protected async Task<OASISResult<T3>> LoadInstalledAsync(Guid avatarId, Guid OAPPSystemHolonId, string version, bool active, ProviderType providerType = ProviderType.Default)
        {
            OASISResult<T3> result = new OASISResult<T3>();
            string errorMessage = "Error occured in OAPPSystemManagerBase.LoadInstalledAsync. Reason: ";
            OASISResult<T3> installedOAPPSystemHolonsResult = await Data.LoadHolonByMetaDataAsync<T3>(new Dictionary<string, string>()
        ...
        protected OASISResult<T3> LoadInstalled(Guid avatarId, Guid OAPPSystemHolonId, string version, bool active, ProviderType providerType = ProviderType.Default)
        {
            OASISResult<T3> result = new OASISResult<T3>();
            string errorMessage = "Error occured in OAPPSystemManagerBase.LoadInstalled. Reason: ";
            OASISResult<T3> installedOAPPSystemHolonsResult = Data.LoadHolonByMetaData<T3>(new Dictionary<string, string>()
        ...
        protected async Task<OASISResult<T3>> LoadInstalledAsync(Guid avatarId, string OAPPSystemHolonName, string version, bool active, ProviderType providerType = ProviderType.Default)
        {
            OASISResult<T3> result = new OASISResult<T3>();
            string errorMessage = "Error occured in OAPPSystemManagerBase.LoadInstalledAsync. Reason: ";
            OASISResult<T3> installedOAPPSystemHolonsResult = await Data.LoadHolonByMetaDataAsync<T3>(new Dictionary<string, string>()
        ...
        protected OASISResult<T3> LoadInstalled(Guid avatarId, string OAPPSystemHolonName, string version, bool active, ProviderType providerType = ProviderType.Default)
        {
            OASISResult<T3> result = new OASISResult<T3>();
            string errorMessage = "Error occured in OAPPSystemManagerBase.LoadInstalled. Reason: ";
            OASISResult<T3> installedOAPPSystemHolonsResult = Data.LoadHolonByMetaData<T3>(new Dictionary<string, string>()
        ...
        protected OASISResult<T3> OpenOAPPSystemHolonFolder(Guid avatarId, T3 holon)
        {
            OASISResult<T3> result = new OASISResult<T3>();
        ...
        protected async Task<OASISResult<T3>> OpenOAPPSystemHolonFolderAsync(Guid avatarId, Guid OAPPSystemHolonId, int versionSequence = 0, ProviderType providerType = ProviderType.Default)
        {
            OASISResult<T3> result = new OASISResult<T3>();
        ...
        protected OASISResult<T3> OpenOAPPSystemHolonFolder(Guid avatarId, Guid OAPPSystemHolonId, int versionSequence = 0, ProviderType providerType = ProviderType.Default)
        {
            OASISResult<T3> result = new OASISResult<T3>();
            string errorMessage = "An error occured in OAPPSystemManagerBase.OpenOAPPSystemHolonFolder. Reason:";
        ...
        protected async Task<OASISResult<T3>> OpenOAPPSystemHolonFolderAsync(Guid avatarId, Guid OAPPSystemHolonId, string version, ProviderType providerType = ProviderType.Default)
        {
            OASISResult<T3> result = new OASISResult<T3>();
            string errorMessage = "An error occured in OAPPSystemManagerBase.OpenOAPPSystemHolonFolderAsync. Reason:";
        ...
        protected OASISResult<T3> OpenOAPPSystemHolonFolder(Guid avatarId, Guid OAPPSystemHolonId, string version, ProviderType providerType = ProviderType.Default)
        {
            OASISResult<T3> result = new OASISResult<T3>();
            string errorMessage = "An error occured in OAPPSystemManagerBase.OpenOAPPSystemHolonFolder. Reason:";
        ...
        protected async Task<OASISResult<bool>> WriteDNAAsync<T>(T OAPPSystemHolonDNA, string fullPathToOAPPSystemHolon)
        {
            OASISResult<bool> result = new OASISResult<bool>();
            ...
            try
            {
                ...
                await File.WriteAllTextAsync(Path.Combine(fullPathToOAPPSystemHolon, OAPPSystemHolonDNAFileName), JsonSerializer.Serialize(OAPPSystemHolonDNA, options));
                result.Result = true;
            }
            catch (Exception ex)
            {
                OASISErrorHandling.HandleError(ref result, $"An error occured writing the {OAPPSystemHolonUIName} DNA in WriteDNAAsync: Reason: {ex.Message}");
            }

            return result;
        }

        protected OASISResult<bool> WriteDNA<T>(T OAPPSystemHolonDNA, string fullPathToOAPPSystemHolon)
        {
            OASISResult<bool> result = new OASISResult<bool>();
            ...
            try
            {
                ...
                File.WriteAllText(Path.Combine(fullPathToOAPPSystemHolon, OAPPSystemHolonDNAFileName), JsonSerializer.Serialize(OAPPSystemHolonDNA));
                result.Result = true;
            }
            catch (Exception ex)
            {
                OASISErrorHandling.HandleError(ref result, $"An error occured writing the {OAPPSystemHolonUIName} DNA in WriteDNA: Reason: {ex.Message}");
            }

            return result;
        }

        //protected async Task<OASISResult<IOAPPSystemHolonDNA>> ReadDNAFromSourceOrInstallFolderAsync(string fullPathToOAPPSystemHolonFolder)
        //{
        ...
        //    catch (Exception ex)
        //    {
        //        OASISErrorHandling.HandleError(ref result, $"An error occured reading the {OAPPSystemHolonDNAFileName} in the {fullPathToOAPPSystemHolonFolder} folder in ReadDNAFromSourceOrInstallFolderAsync: Reason: {ex.Message}");
        //    }

        //    return result;
        //}

        //protected OASISResult<IOAPPSystemHolonDNA> ReadDNAFromSourceOrInstallFolder(string fullPathToOAPPSystemHolonFolder)
        //{
        //    OASISResult<IOAPPSystemHolonDNA> result = new OASISResult<IOAPPSystemHolonDNA>();
        ...
        //    catch (Exception ex)
        //    {
        //        OASISErrorHandling.HandleError(ref result, $"An error occured reading the {OAPPSystemHolonDNAFileName} in the {fullPathToOAPPSystemHolonFolder} folder in ReadDNAFromSourceOrInstallFolder: Reason: {ex.Message}");
        //    }
        ...
        protected async Task<OASISResult<T>> ReadDNAFromSourceOrInstallFolderAsync<T>(string fullPathToOAPPSystemHolonFolder)
        {
            OASISResult<T> result = new OASISResult<T>();
        ...
        protected OASISResult<T> ReadDNAFromSourceOrInstallFolder<T>(string fullPathToOAPPSystemHolonFolder)
        {
            OASISResult<T> result = new OASISResult<T>();
        ...
        protected async Task<OASISResult<T>> ReadDNAFromPublishedFileAsync<T>(string fullPathToPublishedFile)
        {
            OASISResult<T> result = new OASISResult<T>();
            string tempPath = "";
        ...
        protected OASISResult<T> ReadDNAFromPublishedFile<T>(string fullPathToPublishedFile)
        {
            OASISResult<T> result = new OASISResult<T>();
            string tempPath = "";
        ...
        protected async Task<OASISResult<T1>> UpdateNumberOfVersionCountsAsync(Guid avatarId, OASISResult<T1> result, string errorMessage, ProviderType providerType = ProviderType.Default)
        {
            ...
            if (installedversionsResult != null && installedversionsResult.Result != null && !installedversionsResult.IsError)
            {
                foreach (T3 installedOAPPSystemHolon in installedversionsResult.Result)
                {
                    ...
                    OASISResult<T3> installedOAPPSystemSaveResult = await SaveAsync(avatarId, installedOAPPSystemHolon, providerType);
        ...
        protected OASISResult<T1> UpdateNumberOfVersionCounts(Guid avatarId, OASISResult<T1> result, string errorMessage, ProviderType providerType = ProviderType.Default)
        {
            ...
            if (installedversionsResult != null && installedversionsResult.Result != null && !installedversionsResult.IsError)
            {
                ...
                {
                    installedOAPPSystemHolon.OAPPSystemHolonDNA.NumberOfVersions = result.Result.OAPPSystemHolonDNA.NumberOfVersions;
                    OASISResult<T3> installedOAPPSystemSaveResult = Save(avatarId, installedOAPPSystemHolon, providerType);
        ...
        protected async Task<OASISResult<T3>> UpdateInstallCountsAsync(Guid avatarId, T3 installedOAPPSystemHolon, IOAPPSystemHolonDNA OAPPSystemHolonDNA, OASISResult<T3> result, string errorMessage, ProviderType providerType = ProviderType.Default)
        {
            ...
            if (uninstalledholonVersionsResult != null && uninstalledholonVersionsResult.Result != null && !uninstalledholonVersionsResult.IsError)
            {
                foreach (T3 holonVersion in uninstalledholonVersionsResult.Result)
                {
                    ...
                    if (!(holonVersionSaveResult != null && holonVersionSaveResult.Result != null && !holonVersionSaveResult.IsError))
                        OASISErrorHandling.HandleWarning(ref result, $"{errorMessage} Error occured updating the TotalInstalls for Uninstalled {OAPPSystemHolonUIName} with Id {holonVersion.Id} for provider {Enum.GetName(typeof(ProviderType), providerType)}. Reason: {holonVersionSaveResult.Message}");
                }
            }
            else
                OASISErrorHandling.HandleWarning(ref result, $"{errorMessage} Error occured updating the total installs for all Installed {OAPPSystemHolonUIName} versions caused by an error in ListInstalledOAPPSystemHolonsAsync. Reason: {holonVersionsResult.Message}");
        ...
        protected OASISResult<T3> UpdateInstallCounts(Guid avatarId, T3 installedOAPPSystemHolon, IOAPPSystemHolonDNA OAPPSystemHolonDNA, OASISResult<T3> result, string errorMessage, ProviderType providerType = ProviderType.Default)
        {
            ...
            if (installedholonVersionsResult != null && installedholonVersionsResult.Result != null && !installedholonVersionsResult.IsError)
            {
                ...
                OASISErrorHandling.HandleWarning(ref result, $"{errorMessage} Error occured updating the total installs for all Installed {OAPPSystemHolonUIName} versions caused by an error in ListInstalledOAPPSystemHolonsAsync. Reason: {installedholonVersionsResult.Message}");
            ...
            if (uninstalledholonVersionsResult != null && uninstalledholonVersionsResult.Result != null && !uninstalledholonVersionsResult.IsError)
            {
                ...
                OASISErrorHandling.HandleWarning(ref result, $"{errorMessage} Error occured updating the total installs for all Installed {OAPPSystemHolonUIName} versions caused by an error in ListInstalledOAPPSystemHolonsAsync. Reason: {uninstalledholonVersionsResult.Message}");

            return result;
        }

        private async Task<OASISResult<T3>> UninstallAsync(Guid avatarId, OASISResult<T3> installedOAPPSystemHolonResult, string errorMessage, ProviderType providerType)
        {
            OASISResult<T3> result = new OASISResult<T3>();
        ...
        private OASISResult<T3> Uninstall(Guid avatarId, OASISResult<T3> installedOAPPSystemHolonResult, string errorMessage, ProviderType providerType)
        {
            OASISResult<T3> result = new OASISResult<T3>();

            if (installedOAPPSystemHolonResult != null && !installedOAPPSystemHolonResult.IsError && installedOAPPSystemHolonResult.Result != null)
                result = Uninstall(avatarId, installedOAPPSystemHolonResult.Result, errorMessage, providerType);
            else
        ...
        private void OnUploadProgress(Google.Apis.Upload.IUploadProgress progress)
        {
            switch (progress.Status)
            {
                case Google.Apis.Upload.UploadStatus.NotStarted:
                    _progress = 0;
                    OnUploadStatusChanged?.Invoke(this, new OAPPSystemHolonUploadProgressEventArgs() { Progress = _progress, Status = Enums.OAPPSystemHolonUploadStatus.NotStarted });
                    break;
                ...
                case Google.Apis.Upload.UploadStatus.Completed:
                    _progress = 100;
                    OnUploadStatusChanged?.Invoke(this, new OAPPSystemHolonUploadProgressEventArgs() { Progress = _progress, Status = Enums.OAPPSystemHolonUploadStatus.Uploaded });
                    break;
                ...
                case Google.Apis.Upload.UploadStatus.Failed:
                    OnUploadStatusChanged?.Invoke(this, new OAPPSystemHolonUploadProgressEventArgs() { Progress = _progress, Status = Enums.OAPPSystemHolonUploadStatus.Error, ErrorMessage = progress.Exception.ToString() });
                    break;
            }
        }
        ...
        private void OnDownloadProgress(Google.Apis.Download.IDownloadProgress progress)
        {
            switch (progress.Status)
            {
                case Google.Apis.Download.DownloadStatus.NotStarted:
                    _progress = 0;
                    OnDownloadStatusChanged?.Invoke(this, new OAPPSystemHolonDownloadProgressEventArgs() { Progress = _progress, Status = Enums.OAPPSystemHolonDownloadStatus.NotStarted });
                    break;

                case Google.Apis.Download.DownloadStatus.Completed:
                    _progress = 100;
                    OnDownloadStatusChanged?.Invoke(this, new OAPPSystemHolonDownloadProgressEventArgs() { Progress = _progress, Status = Enums.OAPPSystemHolonDownloadStatus.Downloaded });
                    break;
                ...
                case Google.Apis.Download.DownloadStatus.Failed:
                    OnDownloadStatusChanged?.Invoke(this, new OAPPSystemHolonDownloadProgressEventArgs() { Progress = _progress, Status = Enums.OAPPSystemHolonDownloadStatus.Error, ErrorMessage = progress.Exception.ToString() });
                    break;
            }
        }
    }
