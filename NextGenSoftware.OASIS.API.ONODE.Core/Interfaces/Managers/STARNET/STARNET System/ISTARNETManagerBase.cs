...
namespace NextGenSoftware.OASIS.API.ONODE.Core.Interfaces.Managers
{
        ...
        where T3 : IInstalledSTARNETHolon, new()
    {
        ...
        OASISResult<T1> Create(Guid avatarId, string name, string description, object holonSubType, string fullPathToT, Dictionary<string, object> metaData = null, T1 newHolon = default, bool checkIfSourcePathExists = true, ProviderType providerType = ProviderType.Default);
        Task<OASISResult<T1>> CreateAsync(Guid avatarId, string name, string description, object holonSubType, string fullPathToT, Dictionary<string, object> metaData = null, T1 newHolon = default, bool checkIfSourcePathExists = true, ProviderType providerType = ProviderType.Default);
