...
namespace NextGenSoftware.OASIS.API.ONODE.Core.Interfaces.Managers
{
        ...
        where T4 : ISTARNETDNA, new()
    {
        ...
        OASISResult<T3> Install(Guid avatarId, string fullPathToPublishedSTARNETHolonFile, string fullInstallPath, bool createSTARNETHolonDirectory = true, IDownloadedSTARNETHolon downloadedSTARNETHolon = null, bool reInstall = false, ProviderType providerType = ProviderType.Default);
        Task<OASISResult<T3>> InstallAsync(Guid avatarId, string fullPathToPublishedSTARNETHolonFile, string fullInstallPath, bool createSTARNETHolonDirectory = true, IDownloadedSTARNETHolon downloadedSTARNETHolon = null, bool reInstall = false, ProviderType providerType = ProviderType.Default);
        ...
        //Task<OASISResult<T>> LoadAsync<T>(Guid avatarId, Guid id, int version = 0, ProviderType providerType = ProviderType.Default) where T : ISTARNETHolon, new();
        //Task<OASISResult<T>> Load<T>(Guid avatarId, Guid id, int version = 0, ProviderType providerType = ProviderType.Default) where T : ISTARNETHolon, new();
        //Task<OASISResult<T>> LoadAsync<T>(Guid avatarId, string sourcePath, ProviderType providerType = ProviderType.Default) where T : ISTARNETHolon, new();
        //Task<OASISResult<T>> Load<T>(Guid avatarId, string sourcePath, ProviderType providerType = ProviderType.Default) where T : ISTARNETHolon, new();
        Task<OASISResult<T1>> LoadAsyn(Guid avatarId, Guid id, int version = 0, ProviderType providerType = ProviderType.Default);
        Task<OASISResult<T1>> Load(Guid avatarId, Guid id, int version = 0, ProviderType providerType = ProviderType.Default);
        ...
        Task<OASISResult<T1>> LoadForSourceOrInstalledFolder(Guid avatarId, string sourceOrInstallPath, ProviderType providerType = ProviderType.Default);
        ...
        Task<OASISResult<T1>> LoadForPublishedFile(Guid avatarId, string publishedFilePath, ProviderType providerType = ProviderType.Default);
        Task<OASISResult<T1>> LoadForHolonAsync(Guid avatarId, Guid holonId, ProviderType providerType = ProviderType.Default);
        Task<OASISResult<T1>> LoadForHolon(Guid avatarId, Guid holonId, ProviderType providerType = ProviderType.Default);
        OASISResult<T3> LoadInstalled(Guid avatarId, Guid STARNETHolonId, int versionSequence = 0, ProviderType providerType = ProviderType.Default);
        OASISResult<T3> LoadInstalled(Guid avatarId, Guid STARNETHolonId, bool active, int versionSequence = 0, ProviderType providerType = ProviderType.Default);
        ...
        Task<OASISResult<T3>> LoadInstalledAsync(Guid avatarId, Guid STARNETHolonId, int versionSequence = 0, ProviderType providerType = ProviderType.Default);
        Task<OASISResult<T3>> LoadInstalledAsync(Guid avatarId, Guid STARNETHolonId, bool active, int versionSequence = 0, ProviderType providerType = ProviderType.Default);
        ...
        Task<OASISResult<IEnumerable<T>>> LoadVersionsAsync<T>(Guid id, ProviderType providerType = ProviderType.Default) where T : ISTARNETHolon, new();
