    ...
    IOASISSmartContractProvider, IOASISNFTProvider, IOASISNETProvider
{
    ...
    public async Task<OASISResult<IOASISNFT>> LoadNFTAsync(Guid id)
    {
        ...
        {
            var solanaHolonDto =
                await _solanaRepository
                    .GetAsync<SolanaHolonDto>(id.ToString()); //TODO: Need to think how this will work more...
    ...
    public async Task<OASISResult<IOASISNFT>> LoadNFTAsync(string hash)
    {
        ...
        try
        {
            var solanaHolonDto =
                await _solanaRepository
                    .GetAsync<SolanaHolonDto>(hash); //TODO: Need to think how this will work more...
