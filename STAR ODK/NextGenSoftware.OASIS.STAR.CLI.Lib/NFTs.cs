...
namespace NextGenSoftware.OASIS.STAR.CLI.Lib
{
    public class NFTs : STARUIBase<STARNFT, DownloadedNFT, InstalledNFT>
    {
        ...
        //        await base.CreateAsync(createParams, new STARNFT() { NFTId = geoNFTId }, providerType);
        //    else
        ...
        //public static async Task<OASISResult<IOASISGeoSpatialNFT>> MintNFTAsync(object mintParams = null)
        //{
        //    IMintNFTTransactionRequest request = await GenerateNFTRequestAsync();
        //    IPlaceGeoSpatialNFTRequest geoRequest = await GenerateNFTRequestAsync(false);

        //    CLIEngine.ShowWorkingMessage("Minting OASIS Geo-NFT...");
        //    OASISResult<IOASISGeoSpatialNFT> nftResult = await STAR.OASISAPI.NFTs.MintAndPlaceNFTAsync(new MintAndPlaceGeoSpatialNFTRequest()
        //    {
        //        Title = request.Title,
        ...
        //public static async Task PlaceNFTAsync()
        //{
        //    IPlaceGeoSpatialNFTRequest geoRequest = await GenerateNFTRequestAsync(false);
        //    CLIEngine.ShowWorkingMessage("Creating OASIS Geo-NFT...");
        //    OASISResult<IOASISGeoSpatialNFT> nftResult = await STAR.OASISAPI.NFTs.PlaceNFTAsync(geoRequest);
        ...
        //public static async Task ListAllNFTsForBeamedInAvatarAsync(ProviderType providerType = ProviderType.Default)
        //{
        //    CLIEngine.ShowWorkingMessage("Loading Geo-NFTs...");
        //    OASISResult<IEnumerable<IOASISGeoSpatialNFT>> nftsResult = await STAR.OASISAPI.NFTs.LoadAllNFTsForAvatarAsync(STAR.BeamedInAvatar.Id);
        //    // ListHolons<IOASISGeoSpatialNFT>(nftsResult, "Geo-NFT", ShowNFT(x) => { });
        //    ListNFTs(nftsResult);
        //}
        ...
        //{
        //    CLIEngine.ShowWorkingMessage("Loading Geo-NFTs...");
        //    OASISResult<IEnumerable<IOASISGeoSpatialNFT>> nftsResult = await STAR.OASISAPI.NFTs.LoadAllNFTsAsync();
        //    ListNFTs(nftsResult);
        //}
        ...
        //public static void ShowNFT(IOASISGeoSpatialNFT nft)
        //{
        //    string image = nft.Image != null ? "Yes" : "No";
        ...
        //    CLIEngine.ShowMessage($"NFTMetaDataOffChainProvider: {nft.NFTMetaDataOffChainProvider.Name}");
        ...
        //private static async Task<IPlaceGeoSpatialNFTRequest> GenerateNFTRequestAsync(bool isExistingNFT)
        //{
        ...
        //private static void ListNFTs(OASISResult<IEnumerable<IOASISGeoSpatialNFT>> nftsResult)
        //{
        //    if (nftsResult != null)
        //    {
        //        if (!nftsResult.IsError)
        ...
        //                if (nftsResult.Result.Count() == 1)
        //                    CLIEngine.ShowMessage($"{nftsResult.Result.Count()} Geo-NFT Found:");
        //                else
        //                    CLIEngine.ShowMessage($"{nftsResult.Result.Count()} Geo-NFT's' Found:");
        ...
        //        }
        //        else
        //            CLIEngine.ShowErrorMessage($"Error occured loading Geo-NFT's. Reason: {nftsResult.Message}");
        //    }
        //    else
