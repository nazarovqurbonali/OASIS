...
//        /// <returns></returns>
//        public static async Task RunCOSMICTests(OAPPType OAPPType, OAPPTemplateType OAPPTemplateType, Guid OAPPTemplateId, string celestialBodyDNAFolder, string geneisFolder)
//        {
//            CLIEngine.ShowWorkingMessage("BEGINNING STAR ODK/COSMIC TEST'S...");

//            OASISResult<CoronalEjection> result = await GenerateZomesAndHolonsAsync("Zomes And Holons Only", "Zomes And Holons Only Desc", OAPPType, OAPPTemplateType, OAPPTemplateId, celestialBodyDNAFolder, Path.Combine(geneisFolder, "ZomesAndHolons"), "NextGenSoftware.OASIS.OAPPS.ZomesAndHolonsOnly");

//            //Passing in null for the ParentCelestialBody will default it to the default planet (Our World).
//            result = await GenerateCelestialBodyAsync("The Justice League Academy", "Test Moon", null, OAPPType, OAPPTemplateType, OAPPTemplateId, GenesisType.Moon, celestialBodyDNAFolder, Path.Combine(geneisFolder, "JLA"), "NextGenSoftware.OASIS.OAPPS.JLA");
...
//            result = await GenerateCelestialBodyAsync("Our World", "Test Planet", null, OAPPType, OAPPTemplateType, OAPPTemplateId, GenesisType.Planet, celestialBodyDNAFolder, Path.Combine(geneisFolder, "Our World"), "NextGenSoftware.OASIS.OAPPS.OurWorld");
